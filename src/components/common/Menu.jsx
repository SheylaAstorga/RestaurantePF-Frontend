    ...
    return (
        <Navbar expand="lg" className="NavFondo" variant="dark">
            <Container className="d-flex justify-content-around">
                ...
                <Navbar.Brand className="m-0 d-flex justify-content-start logo-brand order-lg-4 flex-grow-1" as={Link} to="/">
                    <img
                        src={logo}
                        alt="logo"
                ...
                <div className="d-flex order-lg-5 flex-grow-0">
                    {usuarioLogueado !== "" ? (
                        <>
                ...
                <Navbar.Collapse id="basic-navbar-nav" className="order-lg-3 links-nav flex-grow-1">
