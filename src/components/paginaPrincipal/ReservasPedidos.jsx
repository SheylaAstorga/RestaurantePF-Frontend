...
const ReservasPedidos = () => {
    return (
        <article className="d-flex p-4  rounded shadow glass-efect">
            ...
            <h2>Anticipa una velada excepcional reservando tu mesa o realizando un pedido anticipado</h2>
            <h2>Disfruta de la comodidad y del arte culinario desde el primer momento</h2>
